...
class TransactionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getIt<TransactionsBloc>()..add(LoadTransactions(cardId)),
      child: _TransactionsView(cardId: cardId),
    );
  }
}
...
class _TransactionsView extends StatelessWidget {
  ...
  const _TransactionsView({required this.cardId});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kart İşlemleri'),
      ),
      body: Column(
        children: [
              ...
              builder: (context, state) {
                ...
                if (state is TransactionsLoaded) {
                  return RefreshIndicator(
                    onRefresh: () async {
                      context.read<TransactionsBloc>().add(RefreshTransactions(cardId));
                    },
